...
@staart/scripts/1.8.0 darwin-x64 node-v13.7.0
$ staart --help [COMMAND]
USAGE
  $ staart COMMAND
...
...
_See code: [src/commands/build.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/build.ts)_
...
_See code: [src/commands/check.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/check.ts)_
...
_See code: [src/commands/controllers.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/controllers.ts)_
...
_See code: [src/commands/docs.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/docs.ts)_
...
_See code: [src/commands/increment.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/increment.ts)_
...
_See code: [src/commands/launch.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/launch.ts)_
...
_See code: [src/commands/start.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/start.ts)_
...
_See code: [src/commands/update.ts](https://github.com/staart/packages/blob/v1.8.0/src/commands/update.ts)_
<!-- commandsstop -->
